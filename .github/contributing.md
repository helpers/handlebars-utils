# Contributing to handlebars-utils

First and foremost, thank you! We appreciate that you want to contribute to handlebars-utils, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for handlebars-utils**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for handlebars-utils:

- star the [project](https://github.com/jonschlinkert/handlebars-utils)
- tweet your support for handlebars-utils
...
- **version**: please note the version of handlebars-utils are you using
...
[so]: http://stackoverflow.com/questions/tagged/handlebars-utils